...
public class ArticleRepository {
    ...
    public void initArticles() {
        Article article1 = new Article(null, "Troubleless", "He was not the Model Boy of the village. He knew the model boy very well though—and loathed him.\n" +
        ...
        Article article4 = new Article(null, "All art is quite useless", "The studio was filled with the rich odour of roses, and when the light summer wind stirred amidst the trees of the garden, there came through the open door the heavy scent of the lilac, or the more delicate perfume of the pink-flowering thorn.\n" +
